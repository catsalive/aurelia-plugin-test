...
var demoAction = function (state, frameworkName) { return __awaiter(void 0, void 0, void 0, function () {
    var newState;
    return __generator(this, function (_a) {
        newState = Object.assign({}, state);
        newState.frameworks = __spreadArrays(newState.frameworks, [frameworkName]);
        return [2, newState];
    });
}); };
var HelloWorld = (function () {
    function HelloWorld(store) {
        this.store = store;
        this.message = '';
